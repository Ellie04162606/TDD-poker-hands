...
public class DemoTest {
  ...
  public void should_return_white_wins_when_play_game_given_black_3H_3D_3S_9C_KD_white_3C_8H_8S_8C_AH() {
    ...
    //then
    assertEquals("White wins. - with Three 8", result);
  }
  ...
  @Test
  public void should_return_white_wins_when_play_game_given_black_3D_3D_KD_KD_KD_white_3C_3H_5S_3C_5H() {
    //given
    String input = "Black: 3D 4D 6D 5D KD  White: 3C 3H 5S 3C 5H";
    ...
    //then
    assertEquals("Black wins. - with full house: King over 3", result);
  }
